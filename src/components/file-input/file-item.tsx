...
const fileItem = tv({
  slots: {
    ...
    icon: 'rounded-full border-4 border-violet-100 bg-violet-200 p-2 text-violet-600 dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-500',
    deleteButton: '',
  },
  variants: {
    state: {
      ...
      complete: {
        container: 'border-violet-500 border-violet-300/30',
      },
      error: {
        container:
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <div className="flex w-full items-center gap-3">
            <div className="h-2 flex-1 rounded-full bg-zinc-100 dark:bg-zinc-600">
              <div
                className="h-full w-4/5 rounded-full bg-violet-600 dark:bg-violet-400"
                style={{
